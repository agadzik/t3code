export interface FileCitationLink {
...
export type FileCitationAttributes = Readonly<Record<string, string | null | undefined>>;
...
export function resolveFileCitationLink(
  attributes: FileCitationAttributes | null | undefined,
): FileCitationLink | null {
...
export function fileCitationMarkdown(citation: FileCitationLink): string {
