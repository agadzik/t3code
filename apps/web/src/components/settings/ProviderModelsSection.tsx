...
const CUSTOM_MODEL_PLACEHOLDER_BY_KIND: Partial<Record<ProviderDriverKind, string>> = {
  [ProviderDriverKind.make("testDriver")]: "gpt-6.7-codex-ultra-preview",
  [ProviderDriverKind.make("otherDriver")]: "claude-sonnet-5",
  [ProviderDriverKind.make("cursor")]: "claude-sonnet-4-6",
  [ProviderDriverKind.make("thirdDriver")]: "openai/gpt-5",
};
