...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.vercelAuthStart]: AuthOrchestrationOperateScope,
  [WS_METHODS.vercelAuthGetStatus]: AuthOrchestrationReadScope,
  [WS_METHODS.vercelAuthLogout]: AuthOrchestrationOperateScope,
  [WS_METHODS.vercelAuthSetApiToken]: AuthOrchestrationOperateScope,
  [WS_METHODS.vercelAuthSetGatewayKey]: AuthOrchestrationOperateScope,
