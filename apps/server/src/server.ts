...
const RuntimeCoreDependenciesLive = ReactorLayerLive.pipe(
  ...
  // The instance registry is the routing keystone — text generation,
  ...
  Layer.provideMerge(VercelAuth.layer.pipe(Layer.provide(ServerSecretStore.layer))),
  Layer.provideMerge(
    Layer.mergeAll(
